...
(deftest initialize-db-sets-defaults
  (testing ":initialize-db populates every fact the Svelte scaffold held"
    ...
    (is (= "Meet Mcp Component" @(rf/subscribe [:app/title])))
    (is (= "meet-mcp-component" @(rf/subscribe [:app/name])))
    (is (= "etzhayyim-project-meet" @(rf/subscribe [:app/project])))
    ...
    (is (= "appview/meet-mcp-component/cljs/src/meet/app.cljs"
